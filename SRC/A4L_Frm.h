...
//---------------------------------------------------------------------------
class TA4L_Form : public TForm
{
__published:	// IDE 管理のコンポーネント
	TBorderEdit *CustomerZipCodeEdit;
	TBorderEdit *CustomerAddress1Edit;
	TBorderEdit *CustomerAddress2Edit;
	TBorderEdit *CustomerTELEdit;
	TBorderEdit *CustomerFAXEdit;
	TImage *StampImage1;
	TImage *StampImage2;
	TImage *LogoImage;
...
private:	// ユーザー宣言
public:		// ユーザー宣言
	__fastcall TA4L_Form(TComponent* Owner);
};
//---------------------------------------------------------------------------
extern PACKAGE TA4L_Form *A4L_Form;
//---------------------------------------------------------------------------
#endif
